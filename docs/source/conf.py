...
# analytical_meanderings documentation build
...
from analytical_meanderings import __version__ as release

# -- Project information -----------------------------------------------------

project = "analytical_meanderings"
author = "Kedro"
...
htmlhelp_basename = "analytical_meanderingsdoc"
...
latex_documents = [
    (
        master_doc,
        "analytical_meanderings.tex",
        "analytical_meanderings Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "analytical_meanderings",
        "Project analytical_meanderings codebase.",
        "Data-Science",
    )
]
